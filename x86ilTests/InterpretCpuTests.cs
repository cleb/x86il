...
namespace x86il.Tests
{
    ...
    public class InterpretCpuTests
    {
        private InterpretCpu RunAsmTest(string filename, Action<InterpretCpu> setup = null)
        {
            ...
            if (setup != null) setup.Invoke(cpu);
        ...
        public void ExecuteTestDec16()
        {
            ...
            Assert.AreEqual(-3, (short) cpu.GetRegister(Reg16.si));
        ...
        public void ExecuteTestPushPop16()
        {
            ...
            Assert.AreEqual(8, (short) cpu.GetRegister(Reg16.si));
        ...
        [Test]
        public void ExecuteTestCmpBlImm8()
        {
            var cpu = RunAsmTest("CmpBlImm8");
            Assert.AreEqual(true, cpu.flagsRegister.HasFlag(Flags.Zero));
        }

        [Test]
        public void ExecuteTestAdcBxImm8()
        {
        ...
        [Test]
        public void ExecuteTestRetn()
        {
            var cpu = RunAsmTest("Retn");
            Assert.AreEqual(4, cpu.GetRegister(Reg16.bx));
